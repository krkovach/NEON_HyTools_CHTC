...
export_dir   = home+"/coeffs/"
export_img   = home+"/imagery/"

config_file = os.path.join(home,"ic_config_"+filename+".json")
...
config_dict['export']['output_dir'] = export_img
...
config_dict["brdf"]['coeff_files'] =  glob.glob(os.path.join(export_dir,"*brdf_coeffs_.json"))
#------------------------------
